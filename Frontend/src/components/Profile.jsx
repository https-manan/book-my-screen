      ...
      {activeTab === "profile" && (
        <div className="bg-white rounded-xl shadow-md overflow-hidden max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 p-6 bg-gradient-to-r from-gray-800 to-pink-500 text-white">
            ...
            <h2 className="text-xl font-semibold">Hi, Amrit</h2>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                <label className="text-gray-500">Married? (Optional)</label>
                <div className="flex gap-2 mt-2">
                  <button className="px-4 py-1 border rounded-md text-gray-600 hover:bg-gray-100">Yes</button>
                  <button className="px-4 py-1 bg-pink-500 text-white rounded-md">No</button>
                </div>
              </div>
            </div>
          </div>
